...
Code available at **[User_Behavior_Analytics](https://github.com/josephmachado/User_Behavior_Analytics)** repository.

### Run on codespaces

You can run this data pipeline using GitHub codespaces. Follow the instructions below.

1. Create codespaces by going to the **[User_Behavior_Analytics](https://github.com/josephmachado/User_Behavior_Analytics)** repository, cloning it(or click `Use this template` button) and then clicking on `Create codespaces on main` button.
...
```bash
git clone https://github.com/josephmachado/User_Behavior_Analytics.git
